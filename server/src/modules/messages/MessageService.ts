...
export class MessageService {
  ...
  async addMessage(from: Ref<User>, msg: String, chatroom: Ref<ChatRoom>, guestId: String, guestName: String, avatarUrl: String) {
    return this.model.create({from, msg, chatroom, guestId, guestName, avatarUrl}).then((createdMessage) => createdMessage)
  }
}
